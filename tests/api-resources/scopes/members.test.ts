...
describe('resource members', () => {
  ...
  test.skip('list', async () => {
    const responsePromise = client.scopes.members.list('/n6i-713uu0l359-w4uvyl7cb9-dq69-k91s48j2c13v/');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('invite: only required params', async () => {
    const responsePromise = client.scopes.members.invite('/n6i-713uu0l359-w4uvyl7cb9-dq69-k91s48j2c13v/', {
      githubLogin: 'ry',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test.skip('invite: required and optional params', async () => {
    const response = await client.scopes.members.invite('/n6i-713uu0l359-w4uvyl7cb9-dq69-k91s48j2c13v/', {
      githubLogin: 'ry',
    });
  });
